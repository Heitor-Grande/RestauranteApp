        ...
        <>
            <div className="col py-3">
                ...
                <div className="float-right text-end">
                    <button hidden={params.status == "CONCLUIDO" ? true : false} className="btn btn-danger" onClick={function () {
                ...
                <form className="form-inline" onSubmit={function (e) {
                    ...
                    <button className="btn btn-secondary m-auto d-block" onClick={function () {
                        ...
                        {params.status == "PENDENTE" ? "PROCESSAR" : params.status == "PROCESSANDO" ? "CONCLUIR" : "FINALIZADO"}</button>
                </form>
