                                            ...
                                            {historico.map(function (pedido) {
                                                ...
                                                return (
                                                    <>
                                                        ...
                                                        <div className={pedido.status == "CANCELADO" ? "col border-bottom bg-danger" : pedido.status == "CONCLUIDO" ? "col border-bottom" : "col border-bottom bg-warning"}>{pedido.id_pedido}</div>
